...
// import { useGetAdminQuery, useGetAnalyticsDataQuery } from "../redux/features/baseAPI/baseApi";
...
//  <div className="basis-6 bg-white flex items-center justify-between rounded-[15px] shadow-md p-6 hover:shadow-lg transition-shadow">
//           <div className="space-y-2">
//             <h1 className="text-gray-800 font-medium">Total Bookings</h1>
//             <h1 className="font-bold text-2xl text-black">545</h1>
//           </div>
...
//         <div className="bg-white basis-6 flex items-center justify-between rounded-[15px] shadow-md p-6 hover:shadow-lg transition-shadow">
//           <div className="space-y-2">
//             <h1 className="text-gray-800 font-medium">Total Bookings</h1>
//             <h1 className="font-bold text-2xl text-black">8574857</h1>
//           </div>
//           <div className="bg-[#B28D28] p-3 rounded-xl">
//             <FaCalendarCheck className="text-white" size={24} />
//           </div>
...
//                     <Line type="monotone" dataKey="value" stroke="#B28D28" strokeWidth={2} dot={{ r: 4 }} activeDot={{ r: 6 }} />
//                   </LineChart>
//                 </ResponsiveContainer>
//               </div>
//             </div>
    ...
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-[15px] shadow-md p-6">
        ...
        {isLoading ? (
          ...
          <p className="text-red-500 text-center">Failed to load revenue data.</p>
        ) : (
          <div className="h-64">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={revenueData}>
