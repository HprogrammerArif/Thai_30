...
//     bookingHistory: [
//       { type: 'Deep Tissue Massage', date: 'Feb 25, 2025', duration: '60 min', price: '$120', status: 'Completed' },
//       { type: 'Swedish Massage', date: 'Feb 28, 2025', duration: '60 min', price: '$120', status: 'Cancelled' },
//     ],
//     preferences: {
...
// <img src="https://t3.ftcdn.net/jpg/02/99/04/20/360_F_299042079_vGBD7wIlSeNl7vOevWHiL93G4koMM967.jpg" alt="" className='h-[150px] rounded-full w-[150px] object-cover border-2 shadow-md shadow-gray-800'  />
//            <div className=''>
//            <h2 className="text-[34px] font-semibold">{customer.name}</h2>
//            <p className="text-[16px] mb-4">Customer since {customer.joinedDate}</p>
//            </div>
// </div>
//             <div className="space-y-2 mt-10">
//               <p className="flex items-center gap-3">
//                 <FaPhoneAlt size={18}/>
//                 <span className='text-[16px] font-bold'>{customer.phone}</span>
//               </p>
//               <p className="flex items-center gap-3">
//                 <FaEnvelope  size={18}/>
//                 <span className='text-[16px] font-bold'>{customer.email}</span>
//               </p>
//               <p className="flex items-center gap-3">
//                 <FaLocationDot size={18}/>
//                 <span className='text-[16px] font-bold'>{customer.address}</span>
//               </p>
//             </div>
//           </div>
...
//               ATTENTION REQUIRED: {customer.cancelledAppointments} cancelled appointments in last 30 days
//             </p>
//           </div>
//         </div>
...
//               ))}
//             </div>
//             <button className="text-[#B28D28] text-sm mt-4">Load previous</button>
//           </div>
...
//                 <p className="font-semibold">{customer.preferences.therapistGender}</p>
//               </div>
//               <div>
...
//                 <p className="font-semibold">{customer.preferences.allergies}</p>
//               </div>
//               <div>
//                 <p className="text-gray-600">Medical Conditions</p>
//                 <p className="font-semibold">{customer.preferences.medicalConditions}</p>
//               </div>
//             </div>
//           </div>
//         </div>
...
const CustomerDetails = () => {
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-4 sm:gap-6 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm sm:text-base">Customer since {customer.joinedDate}</p>
                </div>
              </div>
              <div className="space-y-3 py-10 ms-1">
                <p className="flex items-center gap-3">
                  <FaPhoneAlt size={18} className="text-white" />
                  <span className="text-sm sm:text-base font-medium">{customer.phone}</span>
                </p>
                <p className="flex items-center gap-3">
                  <FaEnvelope size={18} className="text-white" />
                  <span className="text-sm sm:text-base font-medium">{customer.email}</span>
                </p>
                <p className="flex items-center gap-3">
                  <FaLocationDot size={18} className="text-white" />
                  <span className="text-sm sm:text-base font-medium">{customer.address}</span>
                </p>
              </div>
            </div>
          </div>
  ...
  <p className="text-red-600 font-semibold text-sm sm:text-base mt-5">
    ATTENTION REQUIRED <br /> <span className='text-gray-500 font-thin'>{customer.cancelledAppointments} cancelled appointments in the last 30 days</span>
  </p>
</div>
        ...
        <div className="lg:col-span-2 space-y-6">
              ...
              {customer.bookingHistory.map((booking, index) => (
                <div key={index} className="flex items-center justify-between">
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="font-semibold text-sm sm:text-base">{booking.type}</p>
          ...
          <div className="bg-white rounded-[15px] shadow-md py-14 px-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <p className="text-gray-600 text-sm sm:text-base">Preferred Therapist Gender</p>
                <p className="font-semibold text-sm sm:text-base">{customer.preferences.therapistGender}</p>
              </div>
              <div>
                <p className="text-gray-600 text-sm sm:text-base">Pressure Preference</p>
                <p className="font-semibold text-sm sm:text-base">{customer.preferences.pressure}</p>
              </div>
              <div>
                <p className="text-gray-600 text-sm sm:text-base">Allergies</p>
                <p className="font-semibold text-sm sm:text-base">{customer.preferences.allergies}</p>
              </div>
              <div>
                <p className="text-gray-600 text-sm sm:text-base">Medical Conditions</p>
                <p className="font-semibold text-sm sm:text-base">{customer.preferences.medicalConditions}</p>
              </div>
            </div>
          </div>
        </div>
