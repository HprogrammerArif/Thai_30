...
const ClientInfo = () => {
  ...
  const pendingApprovals = [
    { id: 1, name: 'Esthera Jackson', email: 'esthera@gmail.com', specialization: 'Massage Therapist', experience: '4 Years' },
    { id: 2, name: 'Esthera Jackson', email: 'esthera@gmail.com', specialization: 'Massage Therapist', experience: '4 Years' },
    { id: 3, name: 'Esthera Jackson', email: 'esthera@gmail.com', specialization: 'Massage Therapist', experience: '4 Years' },
  ];
      ...
      <div className="bg-white rounded-[15px] shadow-md p-5 mb-10">
            ...
            <tbody>
              {pendingApprovals.map((therapist) => (
                <tr key={therapist.id} className="border-t">
                  ...
                  <td className="p-3">
                    {approvedTherapists[therapist.id] ? (
                      ...
                      <Link 
                        ...
                        className="bg-[#B28D28] w-[90px]  justify-center text-white px-3 py-1 rounded-full flex items-center"
                      >
                  ...
                  <td>
                    <div className="flex items-center gap-3">
                      <button 
                        ...
                        className="bg-[#4AB228] text-white px-3 py-1 rounded-full flex items-center"
                      >
        ...
        <div className="flex justify-start mt-5">
          <div className="flex items-center space-x-2">
            ...
            <button className="px-3 py-1 bg-gray-200 rounded-full hover:bg-[#B28D28] hover:text-white">1</button>
            <button className="px-3 py-1 bg-gray-200 rounded-full hover:bg-[#B28D28] hover:text-white">2</button>
            <button className="px-3 py-1 bg-gray-200 rounded-full hover:bg-[#B28D28] hover:text-white">3</button>
            <button className="px-3 py-1 bg-gray-200 rounded-full hover:bg-[#B28D28] hover:text-white">4</button>
            <button className="px-3 py-1 bg-gray-200 rounded-full hover:bg-[#B28D28] hover:text-white">5</button>
      ...
      <div className="bg-white rounded-[15px] shadow-md p-5">
        <div className="flex justify-between items-center mb-5">
          ...
          <div className="flex space-x-3">
            <select className="border rounded-lg p-2 px-3">
            ...
            />
            <button className="bg-[#B28D28] hover:bg-[#9e7e24] text-white py-2 px-10 rounded-full font-medium">
              Search
            </button>
          </div>
        </div>
