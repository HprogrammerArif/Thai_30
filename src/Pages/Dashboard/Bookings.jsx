      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <p className="font-medium">{bookingDetails?.client_name}</p>
          </div>
          <div>
        ...
        <div className="border-t pt-4 space-y-5">
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div>
              ...
              <p className="font-medium">{bookingDetails?.payment_status || 'Pending'}</p>
            </div>
            <div>
              <p className="text-sm text-gray-500">Payment Method</p>
              <p className="font-medium">{bookingDetails?.payment_method || 'N/A'}</p>
           ...
           <div className="grid grid-cols-3 gap-4">
            <div>
              ...
              <p className="font-medium">${bookingDetails?.commission}</p>
            </div>
            <div>
              <p className="text-sm text-gray-500">Booking Fee</p>
              <p className="font-medium">${bookingDetails?.booking_fee || 'Pending'}</p>
            </div>
            <div>
              <p className="text-sm text-gray-500">Payment Method</p>
              <p className="font-medium">{bookingDetails?.payment_method || 'N/A'}</p>
        ...
        <div className="border-t pt-4 flex justify-end">
          <div className="text-right">
            ...
            <p className="font-bold text-lg">${bookingDetails?.total_amount}</p>
          </div>
        </div>
      </div>
    )}
