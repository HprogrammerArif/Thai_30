...
const Bookings = () => {
  ...
  const bookingsData = [
    ...
    },
    {
      ...
      location: '123 Wellness Ave, San Diego',
    ...
    <section className="">
              ...
              {bookingsData.map((booking, index) => (
                ...
                >
                  ...
                  <td className="p-4">
                    <div className="flex gap-3">
                      <button
                        className="text-gray-500 shadow-lg shadow-gray-300 p-2 rounded-full hover:text-gray-700 transition-colors"
                        title="Edit"
                      >
                        <FiEdit size={20} />
                      </button>
      ...
      <dialog id="booking_modal" className="modal">
        <div className="modal-box bg-white rounded-xl p-6 w-full max-w-3xl">
          <div className="flex justify-between items-center mb-6">
            <h3 className="font-bold text-xl">Session Payment</h3>
            <form method="dialog">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="font-medium">{selectedBooking.therapist.name}</p>
                </div>
                <div>
              ...
              <div className="border-t pt-4">
                <p className="text-sm text-gray-500 font-medium mb-2">Summary</p>
                <div className="grid grid-cols-3 gap-4 text-center">
                  <div>
                    <p className="text-sm text-gray-500">Massage Charges</p>
                    <p className="font-medium">{selectedBooking.charges}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-500">Booking Fee</p>
                    <p className="font-medium">{selectedBooking.bookingFee}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-500">Tip</p>
                    <p className="font-medium">{selectedBooking.tip}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="border-t pt-4 flex justify-between items-center">
                <div>
                  <p className="text-sm text-gray-500">Commission (11% will be deducted)</p>
                  <p className="font-medium">{selectedBooking.commission}</p>
                </div>
                <div className="text-right">
                  <p className="text-sm text-gray-500">Total</p>
                  <p className="font-bold text-lg">{selectedBooking.total}</p>
                </div>
              </div>
            </div>
          )}
      ...
      <div className="bg-white p-5 my-8 rounded-[15px] shadow-md">
        ...
        <div>
        <p className='text-[#B28D28] mt-5 hover:underline cursor-pointer font-medium'>Load More</p>
        </div>
      </div>
    </section>
  );
