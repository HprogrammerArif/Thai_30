...
// import { FaDollarSign, FaStar, FaUsers, FaCrown, FaPlus } from 'react-icons/fa';
...
//          <div>
//          <h2 className="text-lg font-semibold text-gray-800">Promotional Tools</h2>
//          <p className="text-gray-500 ">Create and manage marketing incentives</p>
//          </div>
//           <button className="bg-[#B28D28] text-white px-4 py-2 rounded-full hover:bg-[#9a7b23] transition-colors flex items-center gap-2">
//             <span className="text-lg"><FaPlus size={14}/></span> New Promotion
//           </button>
...
//                     <p className="font-medium text-green-500">{code.discount}</p>
//                   </div>
//                   <p className="text-sm text-gray-500">{code.expiry}</p>
//                 </div>
//               ))}
//             </div>
...
//                 <p className="font-medium text-gray-900">{referralProgram.totalReferrals}</p>
//               </div>
//               <div className="flex justify-between items-center">
//                 <p className="text-gray-600">Active Rewards</p>
//                 <p className="font-medium text-gray-900">{referralProgram.activeRewards}</p>
//               </div>
//               <div className="bg-[#B28D28]/20 rounded-[10px] p-4">
//                 <p className="text-gray-600">Current Reward</p>
//                 <p className="font-medium text-gray-900">{referralProgram.currentReward}</p>
//               </div>
//             </div>
//             <button className="text-[#B28D28] hover:text-[#9a7b23] transition-colors mt-4">Configure rules</button>
//           </div>
...
//                 <p className="font-medium text-gray-900">{loyaltyProgram.activeMembers}</p>
//               </div>
//               <div className="bg-[#FAE08C]/20 rounded-[10px] p-4">
//                 <p className="text-gray-600">Current Reward</p>
//                 <p className="font-medium text-gray-900">{loyaltyProgram.currentReward}</p>
//               </div>
//             </div>
//             <button className="text-[#FFA719] hover:text-[#9a7b23] transition-colors mt-4">Manage program</button>
//           </div>
//         </div>
//       </div>
//     </section>
...
import { FaDollarSign, FaStar, FaUsers, FaCrown, FaPlus, FaCalendarAlt } from 'react-icons/fa';
import { TbReceiptDollar } from 'react-icons/tb';
import { MdDiscount } from 'react-icons/md';
      ...
      <dialog id="new_promotion_modal" className="modal">
        <div className="modal-box p-6 rounded-lg shadow-lg max-w-3xl py-10 ">
          ...
          <form onSubmit={handleSave} className="space-y-4">
            {/* Promotion Title */}
            <div>
              <label className="block text-gray-600 mb-1">Promotion Title</label>
              <input
                type="text"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  type="text"
                  placeholder="March 20, 2025"
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#B28D28] focus:border-transparent"
                  required
                />
                <FaCalendarAlt className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#B28D28]" size={20} />
              </div>
            </div>

            {/* Discount Value */}
            <div>
              <label className="block  text-gray-600 mb-1">Discount Value</label>
