...
//   { therapist: "Esthera Jackson", duration: "60 min", status: "Completed", type: "Swedish Massage" },
//   { therapist: "Tony Adams", duration: "45 min", status: "Scheduled", type: "Swedish Massage" },
//   { therapist: "Forran Torres", duration: "45 min", status: "Scheduled", type: "Deep Tissue Massage" },
//   { therapist: "Rodrygo Del", duration: "30 min", status: "Scheduled", type: "Massage Therapy" },
// ];
...
//   { propertyName: "Esthera Jackson", specialization: "Massage Therapist", experience: "4 Years", documents: "Verified" },
//   { propertyName: "Esthera Jackson", specialization: "Massage Therapist", experience: "4 Years", documents: "Verified" },
//   { propertyName: "Esthera Jackson", specialization: "Massage Therapist", experience: "4 Years", documents: "View" },
//   { propertyName: "Esthera Jackson", specialization: "Massage Therapist", experience: "4 Years", documents: "View" },
// ];
...
//                       : "bg-[#B28D284D]/20 text-[#B28D28] font-semibold"
//                   }`}
//                 >
//                   {booking.status}
//                 </span>
...
//             <div
//               key={index}
//               className="grid grid-cols-5 gap-4 py-3 border-t border-gray-100 hover:bg-gray-50 transition-colors"
//             >
...
// Updated recentBookings with additional fields to match the modal data
const recentBookings = [
  {
...
// Updated Modal component to match the design in the image
const Modal = ({ isOpen, onClose, booking }) => {
  if (!isOpen) return null;

  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-xl p-6 w-full max-w-3xl h-[50vh]">
        <div className="flex justify-between items-start mb-4">
          <h3 className="text-xl font-bold text-gray-800 pb-10">Booking Details</h3>
          <button 
            onClick={onClose}
            className="hover:text-white  hover:bg-red-400 px-[5px] rounded-full"
          >
            ✕
          </button>
        </div>
