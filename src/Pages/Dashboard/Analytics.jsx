      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <div className="bg-white flex items-center justify-between rounded-[15px] shadow-md p-6 hover:shadow-lg transition-shadow">
          <div className="space-y-2">
            ...
            <h1 className="font-bold text-xl text-black">${infoData?.stats?.total_revenue || 0}</h1>
          </div>
        ...
        <div className="bg-white flex items-center justify-between rounded-[15px] shadow-md p-6 hover:shadow-lg transition-shadow">
          <div className="space-y-2">
            ...
            <h1 className="font-bold text-2xl text-black">{infoData?.stats?.total_bookings || 0}</h1>
          </div>
        ...
        <div className="bg-white flex items-center justify-between rounded-[15px] shadow-md p-6 hover:shadow-lg transition-shadow">
          <div className="space-y-2">
            ...
            <h1 className="font-bold text-2xl text-black">{infoData?.stats?.active_therapists || 0}</h1>
          </div>
          <div className="bg-[#B28D28] p-3 rounded-xl">
        ...
        <div className="bg-white flex items-center justify-between rounded-[15px] shadow-md p-6 hover:shadow-lg transition-shadow">
          <div className="space-y-2">
            ...
            <h1 className="font-bold text-xl text-black">{infoData?.stats?.average_rating || 0}/5.0</h1>
          </div>
          <div className="bg-[#B28D28] p-2 rounded-xl">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">
                        Completion rate <span className="text-gray-900">{therapist.completion_rate}</span>
                      </p>
                    </div>
                  </div>
